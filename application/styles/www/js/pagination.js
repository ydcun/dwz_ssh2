DWZ.frag["pagination"] = "<ul><li class=\"j-first pagePre\"><a href=\"#\">首页</a><span>首页</span></li><li class=\"j-prev pagePre\"><a href=\"#\">上一页</a><span>上一页</span></li>#pageNumFrag#<li class=\"j-next pageNext\"><a class=\"next\" href=\"#\">下一页</a><span class=\"next\">下一页</span></li><li class=\"j-last pageNext\"><a class=\"last\" href=\"#\">末页</a><span class=\"last\">末页</span></li><li class=\"jumpto\"><input class=\"textInput\" type=\"text\" size=\"4\" value=\"#currentPage#\" /><input class=\"goto\" type=\"button\" value=\"确定\" /></li></ul>";
(function($){
