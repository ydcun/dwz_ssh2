 ...
 * @since SiteMesh 3
 */
public class Struts2SiteMeshFilter implements Filter {
    ...
    public void doFilter(ServletRequest rq, ServletResponse rs, FilterChain chain)
        ...
        SiteMeshWebAppContext webAppContext = new SiteMeshWebAppContext(new StrutsRequestWrapper(request), response, servletContext);
